...
int main() {
    ...
    try {
            ...
            int number_of_doorways0;
            cin >> number_of_doorways0;
            cout << endl;
            cout << "Add number of windows." << endl;
            int number_of_windows0;
            cin >> number_of_windows0;
            cout << endl;
            double r_width0, r_length0, r_height0;
            ...
            cin >> r_height0;
            cout << endl;
            Windows w0(number_of_windows0);
            windows0.push_back(w0);
            Doorway d0(number_of_doorways0);
            doorways0.push_back(d0);
            room = new Room(r_width0, r_length0, r_height0, windows0, doorways0);
            museum.addRoom(room);
            cout << endl;
            cout << "First room created. What do you want to do next?" << endl;
                        ...
                        case 1: //Witn author
                        {
                            ...
                            switch (n3) {
                                ...
                                case 4: //Sculpture
                                {
                                    ...
                                    cout << "6. Torso." << endl;
                                    cin >> type;
                                    exhibit = new Sculpture(author, name, country, year, s_width, s_length, s_height,
                                                            type);
                                    museum.addExhibit(exhibit);
                                    cout << endl;
                                    break;
                                ...
                                case 6: //Household item
                                {
                                    ...
                                    exhibit = new HouseholdItem(author, name, country, year, h_width, h_length,
                                                                h_height,
                                                                posibilityOfUsing);
                                    museum.addExhibit(exhibit);
                                    cout << endl;
