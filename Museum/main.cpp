                ...
                case 1: //Witn author
                {
                    ...
                    switch (n3) {
                        ...
                        case 3: //Voluminous exhibit
                        {
                            ...
                            cin >> v_height;
                            exhibit = new VoluminousExhibit(author, name, country, year, v_width, v_length, v_height);
                            museum.addExhibit(exhibit);
                            cout << endl;
                            break;
                        }
                        ...
                        case 5: //Technics
                        {
                            ...
                            cout << "6. Rubber." << endl;
                            cin >> material;
                            exhibit = new Technics(author, name, country, year, t_width, t_length, t_height, material);
                            museum.addExhibit(exhibit);
                            cout << endl;
                            break;
                        }
                        case 6: //Household item
                        {
                            ...
                            exhibit = new HouseholdItem(author, name, country, year, h_width, h_length, h_height, posibilityOfUsing);
                            museum.addExhibit(exhibit);
                            cout << endl;
                            break;
                        }
